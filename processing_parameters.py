...
preprocessing_configurations = {"kilosort4": {
    # "spike_interface0": {"detect_saturation_periods": {"saturation_threshold_uV": 1200, "diff_threshold": 300}}, # NP1.0 1200uV, 300; NP2.0 6250uV, 300 (from IBL whitepaper)
                                              ...
                                              "spike_interface2": {"highpass_spatial_filter": {}, # destriping
                                                                #    "silence_periods": {},
                                                                  ...
                                                                  # what is the correct method for saturation mitiagation?, website says use with caution
                                                                      # maybe detect_saturation (IBL for NP1.0 saturation_threshold = 1200uV, diff_threshold=300uV/sample)
...
# implement -> saturation detection first step (value dimis mail), then silence periods after destriping
